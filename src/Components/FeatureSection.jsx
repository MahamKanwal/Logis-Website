...
//                         <div key={index} className="col col-md-6 d-flex align-items-start">
//                             <div
//                                 className="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3"
//                             >
//                                 <i
...
//                                     style={{
//                                         color: feature.iconColor || "#001F8D",
//                                         backgroundColor: feature.iconBgColor || "white",
//                                         fontSize: feature.iconSize || "48px",
//                                     }}
//                                 ></i>
//                             </div>
//                             <div>
//                                 <h3 className="fs-4 text-body-emphasis">{feature.title}</h3>
//                                 <p>{feature.description}</p>
//                                 <div>
//                                     <span className="text-body-emphasis fw-bold">{feature.linkText}</span>
//                                     <i className="fa-solid fa-arrow-right-long"></i>
//                                 </div>
//                             </div>
//                         </div>
